...
Deployment, configuration, observability, and security notes for this container.

- [deployment.md](deployment.md) — Kithara container (ports, mounts, networking)
...
- [security-audit-module-mesh.md](security-audit-module-mesh.md) — Module Registry / mTLS trust audit (Phase 1)
