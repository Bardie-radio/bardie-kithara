...
> **Scope note:** This is a Kithara deep-dive. The shared library model, Tune persistence, and QueueEntry references belong here. **Where** bytes live is [storage.md](storage.md). How Magpie downloads and cache-hits is owned by [Magpie architecture](https://github.com/Bardie-radio/bardie-magpie/tree/main/docs/architecture).
...
|--------|--------------------|
| **Magpie** (ytdl) | Cache-first Tune + blob — deep dive in [Magpie docs](https://github.com/Bardie-radio/bardie-magpie/blob/main/docs/architecture/02-contracts.md) |
| **Catbird** (files) | Tune required — metadata + storage key ([Catbird planned role](https://github.com/Bardie-radio/bardie-catbird/blob/main/docs/architecture/01-planned-role.md)) |
| **Starling** (external / continuous stream) | No Tune — live URI ([Starling planned role](https://github.com/Bardie-radio/bardie-starling/blob/main/docs/architecture/01-planned-role.md)) |
