...
| Codename | Role | MVP |
|----------|------|-----|
| **Magpie** | YouTube / ytdl — search + play; cache-first Tunes ([Magpie docs](https://github.com/Bardie-radio/bardie-magpie/tree/main/docs/architecture)) | Yes |
| **Starling** | External / local stream — re-broadcast direct audio input; no mid-job pause ([planned](https://github.com/Bardie-radio/bardie-starling/blob/main/docs/architecture/01-planned-role.md)) | Future |
| **Catbird** | Local files — play uploaded / local audio ([planned](https://github.com/Bardie-radio/bardie-catbird/blob/main/docs/architecture/01-planned-role.md)) | Future |
